...
test2 = Image.open("C:/Users/Kaliber/Desktop/AI-Developer-Jensen/PythonProjects/ImgClassifierKnn/images/test/9.jpg")
test2 = test2.convert("L")
test2 = test2.resize((2, 2))
test2_data = np.array(test2)
new_shape = test2_data.reshape(-1)

test3 = Image.open("C:/Users/Kaliber/Desktop/AI-Developer-Jensen/PythonProjects/ImgClassifierKnn/images/test/9.jpg")
